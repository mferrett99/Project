...
def start(images):
    ...
    try:
        print("Attempting to locate faces in the images...")
    ...
    print("Faces found, obfuscating the subject(s)")
    known_faces = [
    ...
    print("Subject obfuscated successfully, saving image " + str(counter))
    counter += 1
    end=time.time()
    print(end - start)
